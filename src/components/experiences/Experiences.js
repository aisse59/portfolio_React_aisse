    ...
    return ( 
      ...
      <div className="container mt-10  mx-auto w-full ">
       <div className="relative wrap overflow-hidden p-2 md:p-10 h-full">
         ...
         {/* <!-- right timeline --> */}
          <div className="mb-8 flex justify-center md:justify-between  items-center w-full right-timeline">
           <div className="order-1 md:w-5/12"></div>
            <div className=" -z-20 md:z-20 flex items-center order-1 bg-quaternary shadow-xl w-4 h-4 rounded-full">
           </div>
            <div className="order-1 bg-primary rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4">
              <h3 className="mb-3 font-bold text-quaternary text-xs  md:text-base flex flex-row gap-2">
              ...
              <ul className=" text-xs md:text-sm leading-snug tracking-wide text-quaternary text-opacity-100 px-2 py-2">
          ...
          {/* <!-- left timeline --> */}
         <div className="mb-8 flex justify-center  md:justify-between  flex-row-reverse items-center w-full left-timeline">
           <div className="order-1 md:w-5/12"></div>
            <div className="-z-20 md:z-20 flex items-center order-1 bg-quaternary shadow-xl w-4 h-4  rounded-full">
            </div>
           <div className="order-1 bg-quaternary rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4">
                <h3 className="text-xs md:text-base mb-3 font-bold text-primary flex flex-row gap-2">
                <img src={calendar} alt="calendar" />
         ...
         <div className="mb-8 flex justify-center md:justify-between  items-center w-full right-timeline">
           ...
           <div className="order-1 bg-primary rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4">
                ...
                <ul className="text-xs md:text-sm  leading-snug tracking-wide text-quaternary text-opacity-100 px-2 pt-2">
         ...
         <div className="mb-8 flex justify-center md:justify-between flex-row-reverse items-center w-full left-timeline">
           ...
           <div className="-z-20 md:z-20 flex items-center order-1 bg-quaternary shadow-xl w-4 h-4 rounded-full">
            ...
            <div className="order-1 bg-quaternary rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4">
            <h3 className="mb-3 font-bold text-primary text-xs  md:text-base flex flex-row gap-2">
             <img src={calendar} alt="calendar" /> 
     ...
     <div className="mb-8 flex justify-center md:justify-between items-center w-full right-timeline">
           ...
           <div className="order-1 bg-primary rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4">
                ...
                <ul className="text-xs md:text-sm leading-snug tracking-wide text-quaternary text-opacity-100 gap-2 px-2 pt-2">
