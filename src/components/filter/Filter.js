...
//   const [activeLink, setActiveLink] = useState('langages');
...
//      name="langages"
//      to="/langages" 
//      className={ activeLink === 'langages' ?  " flex flex-row gap-2 justify-center  items-center rounded-2xl py-2 bg-primary text-quaternary text-base hover:text-primary hover:bg-quaternary font-semibold px-5 duration-700 active_styles" : 'flex flex-row gap-2 justify-center  items-center rounded-2xl py-2 bg-primary text-quaternary text-base hover:text-primary hover:bg-quaternary font-semibold px-5 duration-700'}
//      onClick={handleClick}
//      isActive={(match, location) => {
//       return match !== null; // Renvoie true si le lien est actif, sinon false
//     }}
//      >
...
//       name="diplomes"
//       to="/diplomes" 
//       className={ activeLink === 'diplomes' ?  " flex flex-row gap-2 justify-center  items-center rounded-2xl py-2 bg-primary text-quaternary text-base hover:text-primary hover:bg-quaternary font-semibold px-5 duration-700 active_styles" : 'flex flex-row gap-2 justify-center  items-center rounded-2xl py-2 bg-primary text-quaternary text-base hover:text-primary hover:bg-quaternary font-semibold px-5 duration-700'}
//       onClick={handleClick} 
//       isActive={(match, location) => {
//         return match !== null; // Renvoie true si le lien est actif, sinon false
//       }}
...
//       name="experiences"
//       to="/experiences" 
//       className={ activeLink === 'experiences' ?  " flex flex-row gap-2 justify-center  items-center rounded-2xl py-2 bg-primary text-quaternary text-base hover:text-primary hover:bg-quaternary font-semibold px-5 duration-700 active_styles" : 'flex flex-row gap-2 justify-center  items-center rounded-2xl py-2 bg-primary text-quaternary text-base hover:text-primary hover:bg-quaternary font-semibold px-5 duration-700'}
//       onClick={handleClick} 
//       isActive={(match, location) => {
//         return match !== null; // Renvoie true si le lien est actif, sinon false
//       }}
