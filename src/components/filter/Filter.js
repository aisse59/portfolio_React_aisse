...
const Filter = () => {
  return (
    <div className="flex flex-row gap-8 mt-6 mb-6 ml-8">
     <button className="flex flex-row gap-2  items-center rounded-2xl h-12 bg-primary hover:bg-quaternary text-quaternary hover:text-primary font-semibold pl-5 pr-5 duration-700">
